    ...
    setTimeout(() => {
      if (carouselState === 1) {
        document.querySelector(
          ".grid-one"
        ).style.backgroundImage = `url("./images/mobile-image-hero-1.jpg")`;
        ...
        document.querySelector(
          ".grid-one"
        ).style.backgroundImage = `url("./images/mobile-image-hero-2.jpg")`;
        document.querySelector(".grid-two h1").textContent =
        ...
        document.querySelector(
          ".grid-one"
        ).style.backgroundImage = `url("./images/mobile-image-hero-3.jpg")`;
        document.querySelector(".grid-two h1").textContent =
